...
import { CRMRenderer } from "src/code_block_processor/CRMRenderer";
...
export default class ObsidianCRMPlugin extends Plugin {
	...
	async onload() {
		...
		// Initialize the Datacore code block processor
		// this.datacoreProcessor = new DatacoreCodeBlockProcessor(this);
		...
		this.registerView(
			"crm-sidebar",
			(leaf: WorkspaceLeaf) => new CRMSideBarView(leaf, this)
		);
